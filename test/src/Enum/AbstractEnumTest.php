...
final class AbstractEnumTest extends TestCase
{
    ...
    public function testCanCheckValidValue()
    {
        ...
        $this->assertTrue(\Ruga\Std\Test\Enum\Weekday::isValidValue(\Ruga\Std\Test\Enum\Weekday::MONDAY(), false), 'MONDAY() non-strict');
    }
    
    public function testCanGetConstantNameFromValue()
    {
        $this->assertSame('FRIDAY', \Ruga\Std\Test\Enum\Weekday::getConstantName('fri'));
        $this->assertSame('TUESDAY', \Ruga\Std\Test\Enum\Weekday::getConstantName(\Ruga\Std\Test\Enum\Weekday::TUESDAY()));
        $this->expectException(\Ruga\Std\Enum\Exception\OutOfRangeException::class);
    ...
    {
        $this->assertSame('Wednesday', \Ruga\Std\Test\Enum\Weekday::getFullname(\Ruga\Std\Test\Enum\Weekday::WEDNESDAY));
        $this->assertSame('Wednesday', \Ruga\Std\Test\Enum\Weekday::getFullname(\Ruga\Std\Test\Enum\Weekday::WEDNESDAY()));
